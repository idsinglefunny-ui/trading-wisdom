-- TradeYourPlan API Database Initialization Script
-- This script sets up the admin configuration and system quotes
...
-- Create quotes table for system preset quotes
...
SELECT 'Default admin password: admin123' AS admin_info;
